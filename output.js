//Tue Jul 09 2024 10:05:59 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x47a6a8 = _0x3a2f99("美团"),
  _0x188493 = require("got");
let _0x1bb665 = null,
  _0x31b1a8 = null;
const _0x20b8d0 = "meituan",
  _0x4dc0b8 = ["\n", "&", "@"],
  _0xdc7799 = [_0x20b8d0 + "Cookie"];
try {
  _0x1bb665 = require("./mtsig");
} catch (_0x277bf0) {
  _0x31b1a8 = process.env[_0x20b8d0 + "Sign"] || "https://service.leafxxx.win/meituan";
}
const _0x24272f = process.env[_0x20b8d0 + "AutoWithdraw"] || "true",
  _0x1bffba = 15000,
  _0x5c27c5 = 3,
...
let _0x1ad6e9 = "114.07" + _0x47a6a8.randomString(12, _0x28eea2),
  _0x122d4f = "22.52" + _0x47a6a8.randomString(13, _0x28eea2),
  _0x577c0f = "NnOIp-QOs8SiYF1dcSlL5r8phPrCf6qkH7evMyjIoup2NXxNCLYcBbd3bqpv2X2IwEEJb5qoWglfkm_BFMSF_P37OScxhIfzAWgvmEjhdwJlyDXeFPZ0XwraweVp2EDxHrRbGOZeH8QVXwCoLxaUGBeOtuA0cEaD1RsGuHC_D2E",
  _0xac4efd = [],
  _0x382386 = [];
const _0x3d348c = 600,
  _0x5ea9a5 = 10,
...
let _0x191160 = [];
function _0x3b26ec(_0x4eec08) {
  return Buffer.from(_0x4eec08, "utf8").toString("base64");
}
class _0x136d29 {
  constructor() {
    this.index = _0x47a6a8.userIdx++;
    this.name = "";
    this.valid = true;
    const _0x24ad5a = {
      limit: 0
    ...
    this.got = _0x188493.extend(_0x2617fa);
  }
  log(_0x31f409, _0x1c2397 = {}) {
    var _0x42fa02 = "",
      _0x4a4a3f = _0x47a6a8.userCount.toString().length;
    if (this.index) {
      _0x42fa02 += "账号[" + _0x47a6a8.padStr(this.index, _0x4a4a3f) + "]";
    }
    if (this.name) {
      _0x42fa02 += "[" + this.name + "]";
    }
    _0x47a6a8.log(_0x42fa02 + _0x31f409, _0x1c2397);
  }
...
class _0x523575 extends _0x136d29 {
  constructor(_0x479e1c) {
    super();
    if (_0x479e1c.startsWith("token=")) {
      _0x479e1c = _0x479e1c.replace("token=", "");
    }
    this.token = _0x479e1c;
    this.t_earnDaily = 0;
    this.uuid = _0x47a6a8.randomPattern("186ebxxxxxxxx-22e49fxxxxxxxx-0-0-186ebxxxxxxxx");
    this.openid = _0x47a6a8.randomString(7, _0x3e1750) + "-" + _0x47a6a8.randomString(20, _0x3e1750);
    ...
    _0x1bb665 && (this.h5guard = new _0x1bb665(this.cookie, _0x4fb4a4));
  ...
  async get_mtgsig(_0x13df8f, _0x59bcb1) {
    const _0x12f3d1 = {
      a1: "1.0",
      a2: 1683336538151,
      a3: "",
    ...
    if (this.h5guard) {
      _0x5c19e4 = await this.h5guard.sign(_0x13df8f, _0x59bcb1);
    } else {
      if (_0x31b1a8) {
        const _0x2ee03d = {
          url: _0x13df8f,
        ...
        _0x2c53c7 === 0 ? _0x5c19e4 = _0x2de2d2.data : this.log("获取mtgsig失败[" + _0x2c53c7 + "]: " + _0x2de2d2?.["msg"]);
      }
    }
    return _0x5c19e4;
  }
  ...
  async encode_riskForm(_0x427a5d = false) {
    ...
    return _0x3b26ec(JSON.stringify(_0x501593));
  }
  async getLoginedUserInfo(_0x4ef1fe = {}) {
    ...
    try {
      ...
      if (_0x48e5d7?.["mobile"]) {
        ...
        this.log("获取账号信息失败, ck可能失效", _0x5dc18e);
      }
    } catch (_0x232c57) {
  ...
  async inviteFetchcoupon(_0xe33e39 = {}) {
    try {
      ...
      let {
        ...
        _0x2ea33a = _0x47a6a8.get(_0x4f7243, "code", -1),
        _0x57ad77 = _0x47a6a8.get(_0x4f7243, "subcode", -1);
  ...
  async gundamGrabV4(_0x1b2734, _0x707e44 = {}) {
    try {
      ...
      let {
        ...
        _0x551d30 = _0x47a6a8.get(_0x13afb7, "code", -1);
      if (_0x551d30 == 0) {
    ...
    try {
      let _0x367a00 = {
          ...
          searchParams: {
            ...
            cType: _0x47a6a8.get(_0x1ebc3d, "cType", "wm_wxapp"),
            wm_appversion: _0x47a6a8.get(_0x1ebc3d, "wm_appversion", "9.19.6"),
            gdPageId: _0x47a6a8.get(_0x1ebc3d, "gdPageId", "460584"),
            token: this.token,
            userId: this.userId,
            uuid: this.uuid
          },
        ...
        _0x2ae530 = _0x47a6a8.get(_0x44d8ba, "code", -1);
      if (_0x2ae530 == 0) {
        let _0x377830 = [];
    ...
    try {
      let _0xb3e7c5 = {
          ...
          searchParams: {
            ...
            isInDpEnv: 0,
            isMini: 1,
            cType: _0x47a6a8.get(_0x48c814, "cType", "wm_wxapp")
          }
        },
        {
          result: _0xd23aed
        } = await this.request(_0xb3e7c5),
        _0x3bb58b = _0x47a6a8.get(_0xd23aed, "code", -1);
      if (_0x3bb58b == 0) {
        const _0x57c5b1 = {
          act: _0x31e016
        };
    ...
    try {
      ...
      let _0x111302 = {
          ...
          searchParams: {
            isInDpEnv: 0,
            isMini: 1,
            cType: _0x47a6a8.get(_0x309572, "cType", "wm_wxapp")
          },
          json: {
        ...
        _0x451dc1 = _0x47a6a8.get(_0x338dfc, "code", -1);
      if (_0x451dc1 == 0) {
  ...
  async ttsqEntry(_0x13e7d6, _0x2a0cd7 = {}) {
    try {
      ...
      let {
        ...
        _0x24e8b1 = _0x47a6a8.get(_0x4d5a79, "code", -1);
      if (_0x24e8b1 == 0) {
  ...
  async ttsqDoAction(_0x2a3a57, _0x2dbddc, _0x563904 = {}) {
    try {
      let _0x43606c = {
        ...
        _0x321e72 = _0x47a6a8.get(_0x3c6d25, "code", -1);
      if (_0x321e72 == 0) {
  ...
  async ttsqEntryLottery(_0x1062a0, _0x5703a1 = {}) {
    try {
      ...
      let {
        ...
        _0x4e3fca = _0x47a6a8.get(_0x2c445c, "code", -1);
      if (_0x4e3fca == 0) {
  ...
  async ttsqDoActionLottery(_0x204c0d, _0x4fd803, _0x2d7b83 = {}) {
    try {
      let _0x2f3f66 = {
        ...
        _0x1a0b7a = _0x47a6a8.get(_0x235999, "code", -1);
      if (_0x1a0b7a == 0) {
    ...
    try {
      let _0x2d8bde = {
          ...
          searchParams: {
            ...
            ctype: _0x47a6a8.get(_0x544f5c, "ctype", "wm_wxapp"),
            isInDpEnv: 0
          }
        },
        {
        ...
        _0x4b6a31 = _0x47a6a8.get(_0x236eb0, "code", -1);
      if (_0x4b6a31 == 0) {
  ...
  async clockInSign(_0xac8d92, _0x55143d = {}) {
    try {
      ...
      let _0x115320 = {
          ...
          searchParams: {
            isMini: 1,
            ctype: _0x47a6a8.get(_0x55143d, "ctype", "wm_wxapp"),
            isInDpEnv: 0
          },
          json: _0x53e611
        },
        ...
        _0x3d7c45 = _0x47a6a8.get(_0x217976, "code", -1);
      if (_0x3d7c45 == 0) {
  ...
  async getCardInfo(_0x4a6db3, _0x1069ee = {}) {
    try {
      ...
      let {
        ...
        _0x3d6e5d = _0x47a6a8.get(_0x2ccc79, "code", -1);
      if (_0x3d6e5d == 0) {
        ...
        for (let _0x562a31 of _0x354b7c.data) {
          if (!_0x245c43.includes(_0x562a31?.["code"]?.["toString"]())) {
            if (!_0x562a31?.["taskRuleVos"]?.["length"]) {
              _0x47a6a8.log("任务[" + _0x562a31.title + "] -- " + _0x562a31.msg);
              continue;
            }
            ...
            if (_0x47b190 && _0x562a31?.["extend"]?.["isSignInToday"] == 1) {
              _0x47a6a8.log("任务[" + _0x562a31.title + "] -- 已完成");
              continue;
            }
            let _0x2d496d = false;
            ...
            for (let _0x4ffec1 of _0x562a31.taskRuleVos) {
              if (_0x4ffec1.status == "PRIZE_SUCC" || _0x4ffec1.status == "DELETE") {
                !_0x47b190 && _0x47a6a8.log("任务[" + _0x562a31.title + "] -- 已完成");
              } else {
                if (_0x4ffec1?.["status"] == "CAN_RECEIVE") {
                  _0x47a6a8.log("任务[" + _0x562a31.title + "] -- 可领取奖励");
                  const _0x32026b = {
                    need_sign: _0x2d496d
                  };
                  ...
                  _0x47a6a8.log("任务[" + _0x562a31.title + "] -- 未完成");
                  let _0x28cc04 = true,
                  ...
                  if (_0x471337.limitTime) {
                    ...
                    Date.now() < _0x1dd17e && (_0x28cc04 = false, _0x47a6a8.log("任务[" + _0x562a31.title + "]冷却中, [" + _0x47a6a8.time("hh:mm:ss", _0x1dd17e) + "]后可完成"));
                  } else {
                    if (_0x471337?.["timeLimits"]?.["length"]) {
                      let _0x1e5ad1 = new Date(_0x47a6a8.time("yyyy-MM-dd 00:00:00")).getTime(),
                        _0x2f7d43 = Date.now();
                      for (let _0x20de21 of _0x471337.timeLimits) {
                        ...
                        _0x4e1496 += _0x1e5ad1;
                        _0x1c1120 += _0x1e5ad1;
                        (_0x2f7d43 < _0x4e1496 || _0x2f7d43 >= _0x1c1120) && (_0x28cc04 = false, _0x47a6a8.log("任务[" + _0x562a31.title + "]不在时间段中: " + _0x47a6a8.time("hh:mm:ss", _0x4e1496) + "到" + _0x47a6a8.time("hh:mm:ss", _0x1c1120)));
                      }
                    }
                  }
                  if (_0x28cc04) {
    ...
    try {
      ...
      if (_0x46236f?.["code"] == 0) {
        ...
        if (_0x47e552.staySeconds) {
          ...
          await _0x47a6a8.wait(_0x939726);
        } else {
    ...
    try {
      ...
      let _0x3fed59 = {
          ...
          searchParams: {
            ...
            nonceStr: _0x47a6a8.randomString(16),
        ...
        _0x19ed3b = _0x47a6a8.get(_0x381f06, "code", -1);
      if (_0x19ed3b == 0) {
  ...
  async earnDailyPost(_0x7576f8 = {}) {
    ...
    try {
      ...
      await _0x47a6a8.wait_gap_interval(this.t_earnDaily, _0x3d348c);
    ...
    try {
      ...
      };
      {
        let {
          ...
          _0x4c735f = _0x47a6a8.get(_0x920568, "code", -1);
        if (_0x4c735f == 200) {
      ...
      }
      {
        let {
          ...
          _0x55cbb9 = _0x47a6a8.get(_0x50d08b, "code", -1);
        if (_0x55cbb9 == 200) {
      ...
      }
      {
        let {
          ...
          _0x266248 = _0x47a6a8.get(_0x354708, "code", -1);
        if (_0x266248 == 200) {
  ...
  async earnDaily_coinInfo(_0x4f919c = {}) {
    try {
      ...
      let {
        ...
        _0x4074f8 = _0x47a6a8.get(_0x54598d, "code", -1);
      if (_0x4074f8 == 200) {
  ...
  async earnDaily_coinExchange(_0x2efce9, _0x16c18c = {}) {
    try {
      ...
      let {
        ...
        _0x49c5dc = _0x47a6a8.get(_0x186606, "code", -1);
      if (_0x49c5dc == 200) {
  ...
  async earnDaily_sign(_0x5b8ec6 = {}) {
    try {
      ...
      let {
        ...
        _0x491eb4 = _0x47a6a8.get(_0x3b9236, "code", -1);
      if (_0x491eb4 == 200) {
  ...
  async earnDaily_do_task(_0x365201, _0x5530db = {}) {
    try {
      ...
      let {
        ...
        _0x3b2738 = _0x47a6a8.get(_0x315dba, "code", -1);
      if (_0x3b2738 == 200) {
  ...
  async earnDaily_get_reward(_0x1d822b, _0x592449 = {}) {
    try {
      ...
      let {
        ...
        _0x1b9aed = _0x47a6a8.get(_0x5de4e2, "code", -1);
      if (_0x1b9aed == 200) {
  ...
  async earnDaily_redbag(_0x1e06d8 = {}) {
    try {
      ...
      let {
        ...
        _0x1d555e = _0x47a6a8.get(_0x181933, "code", -1);
      if (_0x1d555e == 200) {
  ...
  async earnDaily_draw(_0xc897ee = {}) {
    try {
      ...
      let {
        ...
        _0x36e6ff = _0x47a6a8.get(_0x140e19, "code", -1);
      if (_0x36e6ff == 200) {
  ...
  async earnDaily_get_withdraw_list(_0x2868b9 = {}) {
    try {
      ...
      let {
        ...
        _0x2319dd = _0x47a6a8.get(_0x52f2c9, "code", -1);
      if (_0x2319dd == 200) {
  ...
  async earnDaily_withdraw(_0x2ca30e, _0x37e270 = {}) {
    ...
    try {
      ...
      let {
        ...
        _0x1f0a4f = _0x47a6a8.get(_0x25871b, "code", -1);
      if (_0x1f0a4f == 200) {
        _0x15a23d = true;
        const _0x18b3ce = {
          notify: true
    ...
    try {
      ...
      let _0x23f21f = {
        ...
        json: {
          ...
          t: "1",
          c: "2",
          sessionId: "187a" + _0x47a6a8.randomPattern("xxxxxxx-xxx-xxx-xxx"),
          referrer: "",
          fingerprintFromH5: "eJxVV" + _0x47a6a8.randomString(_0x3076b8, _0x3e1750)
        }
      };
  ...
  async walletMainpage(_0x544ded = {}) {
    try {
      ...
      let {
        ...
        _0x41fb56 = _0x47a6a8.get(_0x27af34, "status", -1);
  ...
  async popupcomponent_popup(_0x37c749, _0x26f176 = {}) {
    try {
      ...
      let {
        ...
        _0x3ebc3d = _0x47a6a8.get(_0x2adb66, "code", -1);
      if (_0x3ebc3d == 0) {
...
!(async () => {
  ...
  await _0x26a723();
  _0x47a6a8.read_env(_0x523575);
  _0x47a6a8.log("\n-------------------------------------");
  _0x24272f == "false" || !_0x24272f ? _0x47a6a8.log("APP每日赚钱设置为: 不随机提现") : _0x47a6a8.log("APP每日赚钱设置为: 每日随机提现");
  _0x1ab535 == "false" ? _0x47a6a8.log("每日赚钱任务开关设置为: 关闭") : _0x47a6a8.log("每日赚钱任务开关设置为: 开启");
  _0x4186a1 == "false" ? _0x47a6a8.log("抽月符任务开关设置为: 关闭") : _0x47a6a8.log("抽月符任务开关设置为: 开启");
  _0x47a6a8.log("-------------------------------------");
  for (let _0xd035a7 of _0x47a6a8.userList) {
    await _0xd035a7.userTask();
  }
})().catch(_0x29622a => _0x47a6a8.log(_0x29622a)).finally(() => _0x47a6a8.exitNow());
  ...
  try {
    ...
    if (_0x4edf42?.["code"] == 0) {
      ...
      if (_0x4edf42?.["commonNotify"] && _0x4edf42.commonNotify.length > 0) {
        ...
        _0x47a6a8.log(_0x4edf42.commonNotify.join("\n") + "\n", _0x1ab29c);
      }
      _0x4edf42?.["commonMsg"] && _0x4edf42.commonMsg.length > 0 && _0x47a6a8.log(_0x4edf42.commonMsg.join("\n") + "\n");
      if (_0x4edf42[_0x16ef55]) {
        let _0x467447 = _0x4edf42[_0x16ef55];
        _0x467447.status == 0 ? _0x248ef1 >= _0x467447.version ? (_0x114d85 = true, _0x47a6a8.log(_0x467447.msg[_0x467447.status]), _0x47a6a8.log(_0x467447.updateMsg), _0x47a6a8.log("现在运行的脚本版本是：" + _0x248ef1.toFixed(2) + "，最新脚本版本：" + _0x467447.latestVersion.toFixed(2))) : _0x47a6a8.log(_0x467447.versionMsg) : _0x47a6a8.log(_0x467447.msg[_0x467447.status]);
      } else {
        _0x47a6a8.log(_0x4edf42.errorMsg);
      }
    }
  } catch (_0x372ef8) {
    _0x47a6a8.log(_0x372ef8);
  } finally {
    return _0x114d85;
  }
}
async function _0x26a723() {
  ...
  try {
    ...
    if (_0x36b907?.["code"] == 0) {
      ...
      _0x577c0f = _0x36b907?.["inviteCode"] || _0x577c0f;
    ...
    _0x47a6a8.log(_0x188cfe);
  } finally {
    return _0x541f16;
  }
}
function _0x3a2f99(_0x5a7171) {
  return new class {
    constructor(_0x412e2d) {
      this.name = _0x412e2d;
    ...
    log(_0x5bb84a, _0x2d4e50 = {}) {
      const _0x429cf0 = {
        console: true
      };
      Object.assign(_0x429cf0, _0x2d4e50);
      if (_0x429cf0.time) {
        let _0xabe8ba = _0x429cf0.fmt || "hh:mm:ss";
        _0x5bb84a = "[" + this.time(_0xabe8ba) + "]" + _0x5bb84a;
      }
      if (_0x429cf0.notify) {
        this.notifyStr.push(_0x5bb84a);
      }
      if (_0x429cf0.console) {
        console.log(_0x5bb84a);
      }
    }
    read_env(_0x40b624) {
      let _0x5dd343 = _0xdc7799.map(_0xc08149 => process.env[_0xc08149]);
      for (let _0x5e25f0 of _0x5dd343.filter(_0x4cd0cc => !!_0x4cd0cc)) {
        let _0x14f7c6 = _0x4dc0b8.filter(_0xf348d6 => _0x5e25f0.includes(_0xf348d6)),
          _0x2232da = _0x14f7c6.length > 0 ? _0x14f7c6[0] : _0x4dc0b8[0];
        for (let _0x10bb8e of _0x5e25f0.split(_0x2232da).filter(_0x4d4eb0 => !!_0x4d4eb0)) {
          this.userList.push(new _0x40b624(_0x10bb8e));
        }
      }
      ...
      if (!this.userCount) {
        ...
        this.log("未找到变量，请检查变量" + _0xdc7799.map(_0x54082d => "[" + _0x54082d + "]").join("或"), _0x3def00);
        return false;
      }
      this.log("共找到" + this.userCount + "个账号");
      return true;
    }
    async threads(_0x1b8478, _0x3bbc4b, _0x276405 = {}) {
      while (_0x3bbc4b.idx < _0x47a6a8.userList.length) {
        let _0x3c3519 = _0x47a6a8.userList[_0x3bbc4b.idx++];
        if (!_0x3c3519.valid) {
          continue;
        }
        await _0x3c3519[_0x1b8478](_0x276405);
      }
    }
    async threadTask(_0x32b8ee, _0xed0bee) {
      let _0x370ace = [];
      const _0x1adc14 = {
        idx: 0
      };
      while (_0xed0bee--) {
        _0x370ace.push(this.threads(_0x32b8ee, _0x1adc14));
      }
      await Promise.all(_0x370ace);
    }
    time(_0x31869c, _0x290d3c = null) {
      let _0x1da5d5 = _0x290d3c ? new Date(_0x290d3c) : new Date(),
        _0x3ec673 = {
          "M+": _0x1da5d5.getMonth() + 1,
          "d+": _0x1da5d5.getDate(),
          "h+": _0x1da5d5.getHours(),
          "m+": _0x1da5d5.getMinutes(),
          "s+": _0x1da5d5.getSeconds(),
          "q+": Math.floor((_0x1da5d5.getMonth() + 3) / 3),
          S: this.padStr(_0x1da5d5.getMilliseconds(), 3)
        };
      /(y+)/.test(_0x31869c) && (_0x31869c = _0x31869c.replace(RegExp.$1, (_0x1da5d5.getFullYear() + "").substr(4 - RegExp.$1.length)));
      for (let _0x32347e in _0x3ec673) new RegExp("(" + _0x32347e + ")").test(_0x31869c) && (_0x31869c = _0x31869c.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x3ec673[_0x32347e] : ("00" + _0x3ec673[_0x32347e]).substr(("" + _0x3ec673[_0x32347e]).length)));
      return _0x31869c;
    }
    async showmsg() {
      if (!this.notifyFlag) {
      ...
      var _0x12325a = require("./sendNotify");
      this.log("\n============== 推送 ==============");
      await _0x12325a.sendNotify(this.name, this.notifyStr.join("\n"));
    }
    padStr(_0x491645, _0x2facdc, _0x513dba = {}) {
      let _0x67071f = _0x513dba.padding || "0",
        _0x545550 = _0x513dba.mode || "l",
        _0x40a476 = String(_0x491645),
        _0x1d5190 = _0x2facdc > _0x40a476.length ? _0x2facdc - _0x40a476.length : 0,
        _0x1af9fa = "";
      for (let _0x22af9b = 0; _0x22af9b < _0x1d5190; _0x22af9b++) {
        _0x1af9fa += _0x67071f;
      }
      _0x545550 == "r" ? _0x40a476 = _0x40a476 + _0x1af9fa : _0x40a476 = _0x1af9fa + _0x40a476;
      return _0x40a476;
    }
    json2str(_0x307f5c, _0x2f678c, _0x2f2758 = false) {
      let _0x61c003 = [];
      for (let _0x17c45e of Object.keys(_0x307f5c).sort()) {
        let _0x1fb555 = _0x307f5c[_0x17c45e];
        if (_0x1fb555 && _0x2f2758) {
          _0x1fb555 = encodeURIComponent(_0x1fb555);
        }
        _0x61c003.push(_0x17c45e + "=" + _0x1fb555);
      }
      return _0x61c003.join(_0x2f678c);
    }
    str2json(_0x1446f5, _0x3b2137 = false) {
      let _0x2eb86e = {};
      for (let _0x25a860 of _0x1446f5.split("&")) {
        if (!_0x25a860) {
          continue;
        }
        let _0x4779b7 = _0x25a860.indexOf("=");
        if (_0x4779b7 == -1) {
          continue;
        }
        let _0x30755c = _0x25a860.substr(0, _0x4779b7),
          _0x41a24a = _0x25a860.substr(_0x4779b7 + 1);
        if (_0x3b2137) {
          _0x41a24a = decodeURIComponent(_0x41a24a);
        }
        _0x2eb86e[_0x30755c] = _0x41a24a;
      }
      return _0x2eb86e;
    }
    randomPattern(_0x3266c9, _0x4e625e = "abcdef0123456789") {
      let _0x1a8916 = "";
      for (let _0x5cb6e1 of _0x3266c9) {
        if (_0x5cb6e1 == "x") {
          _0x1a8916 += _0x4e625e.charAt(Math.floor(Math.random() * _0x4e625e.length));
        } else {
          _0x5cb6e1 == "X" ? _0x1a8916 += _0x4e625e.charAt(Math.floor(Math.random() * _0x4e625e.length)).toUpperCase() : _0x1a8916 += _0x5cb6e1;
        }
      }
      return _0x1a8916;
    }
    randomString(_0x226498, _0x5ab311 = "abcdef0123456789") {
      let _0x3d06c9 = "";
      for (let _0x1f7287 = 0; _0x1f7287 < _0x226498; _0x1f7287++) {
        _0x3d06c9 += _0x5ab311.charAt(Math.floor(Math.random() * _0x5ab311.length));
      }
      return _0x3d06c9;
    }
    randomList(_0x57fa32) {
      let _0x30bcaa = Math.floor(Math.random() * _0x57fa32.length);
      return _0x57fa32[_0x30bcaa];
    }
    wait(_0x1c19c0) {
      return new Promise(_0xce095d => setTimeout(_0xce095d, _0x1c19c0));
    }
    async exitNow() {
      await this.showmsg();
      let _0x3894eb = Date.now(),
        _0x159326 = (_0x3894eb - this.startTime) / 1000;
      this.log("");
      const _0x78a141 = {
        time: true
      };
      this.log("[" + this.name + "]运行结束，共运行了" + _0x159326 + "秒", _0x78a141);
      process.exit(0);
    }
    get(_0x3b4ab4, _0x2cd7ef, _0x5c76c9 = "") {
      let _0x4d9af3 = _0x5c76c9;
      _0x3b4ab4?.["hasOwnProperty"](_0x2cd7ef) && (_0x4d9af3 = _0x3b4ab4[_0x2cd7ef]);
      return _0x4d9af3;
    }
    pop(_0x11f4d5, _0x30a6a5, _0x5039cf = "") {
      let _0x4ea6f8 = _0x5039cf;
      _0x11f4d5?.["hasOwnProperty"](_0x30a6a5) && (_0x4ea6f8 = _0x11f4d5[_0x30a6a5], delete _0x11f4d5[_0x30a6a5]);
      return _0x4ea6f8;
    }
    copy(_0x3052aa) {
      return Object.assign({}, _0x3052aa);
    }
    async wait_gap_interval(_0x549dd7, _0x4cdc9b) {
      let _0xc64e3e = Date.now() - _0x549dd7;
      _0xc64e3e < _0x4cdc9b && (await this.wait(_0x4cdc9b - _0xc64e3e));
    }
  }(_0x5a7171);
}